...
Me chamo Marcos Felipe França, tenho 25 anos e estudo **Ciência da Computação na UNITRI** (Uberlândia, MG).
...
- 🏗️ **Desenvolvimento Web** com foco em front-end moderno (React, TypeScript) e back-end com .NET
- ☁️ **Deploy em nuvem** (Azure App Service + Azure SQL em produção)
- 🔄 **CI/CD automatizado** com GitHub Actions
- 🧩 **Arquitetura em Camadas** & Clean Code
- 🔗 **Integração com APIs externas** (ViaCEP, câmbio em tempo real, WhatsApp)
- 🧪 **Testes Automatizados** com xUnit
- 📊 **Interfaces Modernas** & Responsivas (Tailwind CSS, Shadcn/ui, Radix UI)
