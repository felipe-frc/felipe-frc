...
**Linguagens e Ferramentas que utilizo e estudo atualmente:**
...
Meu objetivo não é apenas “fazer funcionar”, mas **entender o problema, a solução e o porquê de cada decisão no código**.

---

### 🚀 Objetivo Profissional

Atualmente busco minha **primeira experiência como estagiário em TI**, onde eu possa:

- Aprender com profissionais mais experientes  
- Aplicar os conceitos estudados na prática  
- Evoluir tecnicamente de forma consistente  
- Contribuir com soluções bem pensadas e organizadas  
